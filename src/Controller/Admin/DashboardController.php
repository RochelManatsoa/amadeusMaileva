...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Catégorie d\'article de blog', 'far fa-folder-open', BlogCategory::class);
        yield MenuItem::linkToCrud('Article de blog', 'fas fa-clipboard', BlogPost::class);
    }
}
